            ...
            value: function (e) {
              ...
              try {
                for (
                  ...
                  for (
                    var l = i.value, u = null, s = /^data-path-([0-9]+)$/g;
                    (u = s.exec(l.nodeName));
        ...
        n(t, [
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                (n.minElements = e.element.querySelectorAll(
                  '[data-type="min"]'
                )),
                (n.maxElements = e.element.querySelectorAll(
                  '[data-type="max"]'
                )),
                o)
              ) {
                ...
                if (n.id) {
                  ...
                  if (b && b.value) {
                    ...
                    2 === m.length &&
                      ((n.from = Number(m[0]) || 0), (n.to = Number(m[1]) || 0))
                  }
                }
          ...
          [
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  (r.lastButtons = r.element.querySelectorAll(
                    '[data-type="last"]'
                  )),
                  (r.prevButtons = r.element.querySelectorAll(
                    '[data-type="prev"]'
                  )),
                  (r.nextButtons = r.element.querySelectorAll(
                    '[data-type="next"]'
                  )),
                  t.bindEventHandler(
                    r.firstButtons,
                    ...
                    for (
                      var a,
                        l = function () {
                          ...
                          var O = Array.from(n.element.classList).filter(
                              function (e) {
                                return (
        ...
        n(e, null, [
          ...
          },
          {
            ...
            value: function (t, r) {
              ...
              if ('cookies' === t)
                for (
                  var o = document.cookie.split(';'), i = 0;
                  i < o.length;
                  i++
                ) {
